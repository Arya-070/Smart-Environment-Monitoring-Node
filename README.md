...
<pre> ```mermaid graph TD A[🔋 Power Supply (Battery + AMS1117)] 
  --> B[🧠 ESP32-WROOM-32 Core] B
  --> C[🌡️ BME280 Sensor (I2C)] B
  --> D[📺 OLED Display (I2C)]  B 
  --> E[📡 SX1262 LoRa Module (SPI)] B
  --> F[🔌 USB to Serial (CH340C, Auto Reset) - UART] F
  --> G[💻 USB Port] style 
